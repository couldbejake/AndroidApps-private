...
public class CollectibleHighJump extends CollectibleItem {

    //TODO: Destroy item on left;
    boolean hasInitialised = false;
    boolean randomPosition = false;

    public CollectibleHighJump(FlappyBird game, double v, boolean randomPosition) {
        super(game, v);
        this.randomPosition = randomPosition;
        Bitmap unscaledTexture = BitmapFactory.decodeResource
                (game.getContext().getResources(),
                        R.drawable.powerup_speedboost);
